...
function Load_Plascon_Gloss_View ()
{
        // window.location="PlasconGloss.html"

    if(!navigator.onLine) {ShowAlertBox ()}
    if(navigator.onLine) {window.location="PlasconGloss.html"}
}
function Load_Plascon_Pack_View (){window.location="PlasconPack.html"}
function Load_Plascon_Sundry_View ()
{
    // window.location="PlasconSundry.html"
    if(!navigator.onLine) {ShowAlertBox ()}
    if(navigator.onLine) {window.location="PlasconSundry.html"}
}
